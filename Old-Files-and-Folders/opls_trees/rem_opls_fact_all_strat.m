function[CV_array,accuracy,W,B_pls,C,R2_X,R2_Y,Y,P,T_ortho,X,T,U,num_OPLS_fact,press,Q2,P_ortho] = rem_opls_fact_all_strat(X,Y,CV_array,num_OPLS_fact)
press = 0;
y_sum = 0;
errors = 0;
