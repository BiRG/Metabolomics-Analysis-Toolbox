function [CV_array,accuracy,M_Y,W,B_pls,C,R2_X,R2_Y,Y,P,M_X,T_ortho,S_Y,X,S_X,T,U,nOPLSfact,press,Q2,SE,P_ortho,Y_pred,Q2s] = opls_script_strat_splot(X,Y,CV)
...
[CV_array,accuracy,W,B_pls,C,R2_X,R2_Y,Y,P,T_ortho,X,T,U,nOPLSfact,press,Q2,SE,P_ortho,Y_pred,Q2s] = rem_opls_fact_all_strat_splot(X_ori,Y_ori,CV_array,prev_num_OPLS_fact);
