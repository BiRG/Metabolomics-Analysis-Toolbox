function fix_DAB_plot(varargin)
...
for i = 1:length(outm)
    fields = split(outm{i},',');
    if strcmp(fields{1},'d0')
        times{end+1} = '0';
    elseif strcmp(fields{1},'d1')
        times{end+1} = '1';
    elseif strcmp(fields{1},'d2')
        times{end+1} = '2';
    elseif strcmp(fields{1},'d3')
        times{end+1} = '3';        
    elseif strcmp(fields{1},'d4')
        times{end+1} = '4';        
    end
...
control_inxs = 1:5;
treatment_inxs = 6:10;
h_legend = legend(outh([15,16,17,18,19,6,11,1]),{outm{[15,16,17,18,19,6,11,1]}},'Location','NorthWest');
