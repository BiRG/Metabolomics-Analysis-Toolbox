        ...
        %
            if nargin > 0
                ...
                if rough_window_samples < 2
                    ...
                    filtered_peak_xs = peak_xs(peak_xs <= region_max & peak_xs >= region_min);
                    [BETA0,lb,ub] = deconv_initial_vals_summit(x,y, ...
                        region_min, region_max, filtered_peak_xs, ...
                        model.max_rough_peak_width, rough_window_samples, ...
                        100, false, @(f,ps,pk) waitbar(f/2, wait_h, ...
