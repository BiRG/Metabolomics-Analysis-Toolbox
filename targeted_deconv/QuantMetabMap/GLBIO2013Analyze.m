function GLBIO2013Analyze( results )
% Prints a summary of the analysis of the results from the GLBIO2013 experiments
    ...
    function param_error_list = calc_param_error_list(results)
        ...
        % error_diff - (scalar) mean_error_summit - mean_error_anderson
        persistent param_error_l;
        
        if isempty(param_error_l)
            n = length(results);
            ...
            % Preallocate it.
            param_error_l(12*n).collision_prob = 0;
            param_error_l(12*n).peak_picking_name = '';
            param_error_l(12*n).parameter_name = '';
            param_error_l(12*n).datum_id = '';
            param_error_l(12*n).mean_error_anderson = 0;
            param_error_l(12*n).mean_error_summit = 0;
            param_error_l(12*n).error_diff = 0;
            param_error_l_idx = 1;
            ...
            for results_idx = 1:n
                ...
                for peak_picking_name_idx = 1:length(pp_names)
                    ...
                    for param_idx = 1:num_params
                        ...
                        pe.error_diff = pe.mean_error_summit - pe.mean_error_anderson;

                        % Assign it to the list of param_error_list 
                        param_error_l(param_error_l_idx) = pe;
                        param_error_l_idx = param_error_l_idx + 1;
                    end
        ...
        param_error_list = param_error_l;
    end

pe_list = calc_param_error_list(results);
