function test_suite = test_GLBIO2013_calc_param_rel_error_list %#ok<STOUT>
% matlab_xUnit tests excercising GLBIO2013_calc_param_rel_error_list
%
% Usage:
%   runtests test_GLBIO2013_calc_param_rel_error_list 
initTestSuite;
...
pe = GLBIO2013_calc_param_rel_error_list(high_cong_10);
...
abs_err = abs(orig_aligned_heights - deconv_aligned_heights)./abs(orig_aligned_heights);
...
abs_err = abs(orig_aligned_widths - deconv_aligned_widths)./abs(orig_aligned_widths);
...
abs_err = abs(orig_aligned_lors - deconv_aligned_lors)./abs(orig_aligned_lors);
...
abs_err = abs(orig_aligned_locations - deconv_aligned_locations)./abs(orig_aligned_locations);
...
abs_err = abs(orig_aligned_areas - deconv_aligned_areas)./abs(orig_aligned_areas);
...
abs_err = abs(orig_aligned_half_height_widths - deconv_aligned_half_height_widths)./abs(orig_aligned_half_height_widths);
...
abs_err = abs(orig_aligned_lorentziannesss- deconv_aligned_lorentziannesss)./abs(orig_aligned_lorentziannesss);
...
pe = GLBIO2013_calc_param_rel_error_list(most_cong_10);
