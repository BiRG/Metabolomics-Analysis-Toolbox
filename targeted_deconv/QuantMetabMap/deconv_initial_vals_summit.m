function [BETA0,lb,ub] = deconv_initial_vals_summit(x,y, region_min, region_max, peak_xs, max_width, num_neighbors, min_width_outlier_percentile,progress_func)
%Computes starting values for the deconvolution fitting routines using summit_deconv
% Usage: [BETA0,lb,ub] = deconv_initial_vals_summit(x,y, region_min, region_max, peak_xs, max_width, num_neighbors, min_width_outlier_percentile,progress_func)
%
% -------------------------------------------------------------------------
% Input arguments
% -------------------------------------------------------------------------
