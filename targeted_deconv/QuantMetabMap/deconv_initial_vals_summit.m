function [BETA0,lb,ub] = deconv_initial_vals_summit(x,y, region_min, region_max, peak_xs, max_width, num_neighbors, min_width_outlier_percentile, use_baseline_in_starting_point, progress_func)
%Computes starting values for the deconvolution fitting routines using summit_deconv
% Usage: [BETA0,lb,ub] = deconv_initial_vals_summit(x,y, region_min, region_max, peak_xs, max_width, num_neighbors, min_width_outlier_percentile, use_baseline_in_starting_point, progress_func)
%
% -------------------------------------------------------------------------
% Input arguments
% -------------------------------------------------------------------------
...
%
% num_neighbors The number of neighbor samples used in the summit
%     deconvolution
%
% min_width_outlier_percentile (scalar) The width boundary is calculated
%     using a modification of a standard formula for extreme outliers. 
...
%
% use_baseline_in_starting_point (logical) if true, the deconvolution
%     starting point calculation should consider the baseline (that is, use
%     summit_deconvolve_baseline rather than vanilla summit_deconvolve)
%
...
if use_baseline_in_starting_point
    peaks = summit_deconvolve_baseline(bx, by, peak_xs, max_width, ...
...
elseif length(locs) == 1
    ...
    error('deconv_initial_vals_summit:at_least_one_peak', ...
