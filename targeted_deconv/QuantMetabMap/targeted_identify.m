...
handles.models(num_bins, num_samples)=RegionalSpectrumModel('constant', 0, 0, 0.0052, 0.05, false, 'Summit-Focused');
for b=1:num_bins
    for s=1:num_samples
        handles.models(b, s)=RegionalSpectrumModel('constant', 0, 0, 0.0052, 0.05, false, 'Summit-Focused');
    end
end
