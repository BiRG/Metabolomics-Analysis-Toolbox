function test_suite = test_GLBIO2013_sample_from_kl_divergence_of_2_dirichlet_belief %#ok<STOUT>
%matlab_xUnit tests excercising GLBIO2013_sample_from_kl_divergence_of_2_dirichlet_belief
%
% Usage:
%   runtests test_GLBIO2013_sample_from_kl_divergence_of_2_dirichlet_belief
initTestSuite;
...
actual = GLBIO2013_sample_from_kl_divergence_of_2_dirichlet_belief([10,20,70],[100,200,300], 10);
...
actual = GLBIO2013_sample_from_kl_divergence_of_2_dirichlet_belief([0.5,0.5],[1,1], 10);
assertEqual(expected, actual);
