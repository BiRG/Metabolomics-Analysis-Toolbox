function test_suite = test_sample_from_kl_divergence_of_dirichlet_belief%#ok<STOUT>
%matlab_xUnit tests excercising sample_from_kl_divergence_of_dirichlet_belief
%
% Usage:
%   runtests test_sample_from_kl_divergence_of_dirichlet_belief
initTestSuite;
...
actual = sample_from_kl_divergence_of_dirichlet_belief([0.1,0.2,0.7],[1,2,3], 10);
...
actual = sample_from_kl_divergence_of_dirichlet_belief([0.5,0.5],[1,1], 10);
assertEqual(expected, actual);
