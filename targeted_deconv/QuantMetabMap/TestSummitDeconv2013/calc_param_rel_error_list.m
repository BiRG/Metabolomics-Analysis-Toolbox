function param_error_list = calc_param_rel_error_list(results)
% Takes the results (an array of ExpDatum objects) and extracts more-easily analyzable statistics. This version extracts relative errors.
%
