function test_suite = test_calc_param_error_list %#ok<STOUT>
% matlab_xUnit tests excercising calc_param_error_list
%
% Usage:
%   runtests test_calc_param_error_list 
initTestSuite;
...
pe = calc_param_error_list(high_cong_10);
...
pe = calc_param_error_list(most_cong_10);
