 ...
 */
FARPROC WINAPI Adjacent_Deconvolution_v1_betaDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = Adjacent_Deconvolution_v1_betaDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = Adjacent_Deconvolution_v1_betaDelayLoadWin32FailureHook;
#endif
