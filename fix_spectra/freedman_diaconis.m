function [n_bins, bin_width] = freedman_diaconis( data )
...
% -------------------------------------------------------------------------
% 
% n_bins   -  a scalar giving the number of bins to use with the given bin
%             width
%
...
% -------------------------------------------------------------------------
%
% >> [n_bins, bin_width] = freedman_diaconis([1,1,2,3,3,3,3,6])
% 
