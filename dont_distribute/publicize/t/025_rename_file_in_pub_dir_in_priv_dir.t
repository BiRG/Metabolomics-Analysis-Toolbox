...
system('mkdir',catdir($src_name,'privd_full_1','pub_sub'));
system('echo "Txt: file_in_pub_sub" > '.
       catfile($src_name,'privd_full_1','pub_sub','renamed_in_pub_sub'));
...
{ 
	...
	pub_sub=>{
	    renamed_in_pub_sub=>"Txt: file_in_pub_sub\n"
	}
    },
    privd_empty=>{},
};
...
#Changes for this particular test
system('mkdir','-p',catdir($dest_name,'privd_full_1','pub_sub'));
system('echo "Txt: file_in_pub_sub" > '.
       catfile($dest_name,'privd_full_1','pub_sub','file_in_pub_sub'));
...
{ 
    ...
    privd_full_1=>{
	pub_sub=>{
	    file_in_pub_sub=>"Txt: file_in_pub_sub\n"
	}
    },
    pubd_empty=>{},
};
