...
#Check that dont_delete dir_in_root_dir; will preserve that directory from
#deletion by delete_dest
...
#Test to make sure that the dest structure is as expected
is_deeply(dir_as_hash($dest_name), {destdirFull=>{ destFullFile=>"" }},
   "dest has everything but destdirFull and contents removed");
