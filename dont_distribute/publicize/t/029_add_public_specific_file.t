...
system('mkdir','-p',catdir($src_name,'public_only','pub_only_dir'));
system('echo "Txt: pub_only_file" > '.
       catfile($src_name,'public_only','pub_only_file'));
system('echo "Txt: pub_only_sub_file" > '.
       catfile($src_name,'public_only','pub_only_dir','pub_only_sub_file'));
