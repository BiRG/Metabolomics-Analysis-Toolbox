...
system('mkdir',catdir($src_name,'new_public_dir'));
system('echo "new public file" > '.catfile($src_name,'new_public_dir','new_public_file'));


my $src_expected_structure_before = 
{ 
    new_public_dir=>{new_public_file=>"new public file\n"},
    ".git"=>{
	config=>"[core]\n\trepositoryformatversion = 0\n".
	    "\tfilemode = true\n\tbare = false\n\tlogallrefupdates = true\n"},
