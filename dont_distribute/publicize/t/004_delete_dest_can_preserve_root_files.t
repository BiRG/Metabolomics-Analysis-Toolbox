...
#Check that dont_delete file_in_root_dir; will preserve that file from
...
#Test to make sure that the dest structure is as expected
is_deeply(dir_as_hash($dest_name), {dest2=>''},
   "dest has correct final structure (everything but dest2 removed)");
