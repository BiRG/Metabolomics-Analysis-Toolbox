...
#Check that dont_delete wildcard_in_root_dir; will preserve multiple
#files from deletion by delete_dest
...
#Test to make sure that the dest structure is as expected
is_deeply(dir_as_hash($dest_name), {dest1=>'',dest2=>''},
   "dest has correct final structure (everything but dest1 and dest2 removed)");
