...
#Check that dont_delete dir/file; will preserve dir and dir/file but
#not dir/fileOther
...
{ dest1=>"", dest2=>"", destdirFull=>{ destFullFile1=>"", destFullFile2=>"" },
  destdirEmpty=>{} };
...
#Test to make sure that the dest structure is as expected
is_deeply(dir_as_hash($dest_name), {destdirFull=>{ destFullFile1=>"" }},
   "dest has everything but destdirFull/destFullFile1 removed");
