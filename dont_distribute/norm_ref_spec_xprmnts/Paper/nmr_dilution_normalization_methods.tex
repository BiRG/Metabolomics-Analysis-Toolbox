...
The diversity of noise factors has spawned an equal diversity of normalization techniques. Most techniques are not connected with a specific factor but are justified on general grounds of producing desirable signal characteristics or of enhancing discrimination between groups in a particular class of subjects.
