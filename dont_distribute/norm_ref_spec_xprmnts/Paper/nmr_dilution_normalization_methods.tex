...
\todo{Mention other functions for different types of normalization: range scaling and auto-scaling remove the dependence of rank of metabolites in PCA space on the average concentration and the magnitude of the fold changes (van den Berg 2006)}
