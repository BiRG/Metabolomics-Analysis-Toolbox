...
for i=1:length(subdirs)
    ...
    spectra{i}.description=sprintf(['Collection for testing histogram '...
    ...
    spectra{i}.classification=arrayfun(@(x) sprintf('Group %d loaded from %s', i,full_file_name),1:num_samples,'UniformOutput',false); % Classify by original file
