function [spec,ppm1,ppm2,bytordp] = metassimulo_specread(expname,expno,procno,disk,user)
% specread: read binary Bruker spectrum
% [spec[,ppm1,ppm2,byteordp]] = metassimulo_specread(expname,expno,procno[,disk,user]) 
%
...
%
% This code is taken from MetAssimulo 1.2 and is included here to make
% testing of the simulated output for metassimulo possible without
% hard-coding paths from my development system.
