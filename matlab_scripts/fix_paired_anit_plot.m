function fix_paired_anit_plot(varargin)
...
% Adjust the order
for i = 1:length(outm)
    if strcmp(outm{i},'1-0,Control')
        outm{i} = 'd1 minus d0';
    elseif strcmp(outm{i},'2-0,Control')
        outm{i} = 'd2 minus d0';
    elseif strcmp(outm{i},'3-0,Control')
        outm{i} = 'd3 minus d0';
    elseif strcmp(outm{i},'4-0,Control')
        outm{i} = 'd4 minus d0';
    end
end
control_inxs = 1:4;
