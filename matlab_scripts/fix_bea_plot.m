function fix_bea_plot(varargin)
...
for i = 1:length(outm)
    ...
    if strcmp(outm{i},'0,BE 0')
        outm{i} = 'd0';
    elseif strcmp(outm{i},'24,BE 0')
        outm{i} = 'd1';
    elseif strcmp(outm{i},'48,BE 0')
        outm{i} = 'd2';
    elseif strcmp(outm{i},'72,BE 0')
        outm{i} = 'd3';
    elseif strcmp(outm{i},'96,BE 0')
        outm{i} = 'd4';
    end
end
control_inxs = 1:5;
